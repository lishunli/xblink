...
public class ApadterFactoryTest extends TestCase {
	...
	public void testXMLAdapterFactory() throws Exception{
		...
		System.out.println(AdapterFactory.getAdapter().getClass().getName());
		System.out.println("指定xpp查找结果");
		System.out.println(AdapterFactory.getAdapter(new XppDomDriver()).getClass().getName());
		System.out.println("指定dom4j查找结果");
		System.out.println(AdapterFactory.getAdapter(new Dom4jDomDriver()).getClass().getName());
	}
}
