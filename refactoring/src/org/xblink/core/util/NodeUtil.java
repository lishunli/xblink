...
public class NodeUtil {
	 ...
	 * @return 节点
	 */
	public static XMLNode getTarNode(XMLNode rootNode, String nodeName, Adapter xmlAdapter) {
	...
	public static Object getObject(XMLNode baseNode, ClassLoaderSwitcher classLoaderSwitcher,
			Adapter xmlAdapter) throws Exception {
		Object obj = null;
	 ...
	 * @return 值
	 */
	public static String getAttributeValue(XMLNode baseNode, String xpath, Adapter xmlAdapter) {
